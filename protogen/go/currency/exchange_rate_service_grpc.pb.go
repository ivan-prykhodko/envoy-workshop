...
const (
	ExchangeRateService_GetExchangeRate_FullMethodName = "/currency.ExchangeRateService/GetExchangeRate"
)
...
func (c *exchangeRateServiceClient) GetExchangeRate(ctx context.Context, in *ExchangeRateRequest, opts ...grpc.CallOption) (*ExchangeRateResponse, error) {
...
func (UnimplementedExchangeRateServiceServer) GetExchangeRate(context.Context, *ExchangeRateRequest) (*ExchangeRateResponse, error) {
...
func _ExchangeRateService_GetExchangeRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeRateServiceServer).GetExchangeRate(ctx, req.(*ExchangeRateRequest))
	}
...
var ExchangeRateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "currency.ExchangeRateService",
	...
	Metadata: "protobuf/currency/exchange_rate_service.proto",
}
